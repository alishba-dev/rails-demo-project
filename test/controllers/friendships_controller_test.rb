...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { admin_id: @friendship.admin_id, create: @friendship.create, destroy: @friendship.destroy, friend_id: @friendship.friend_id } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { admin_id: @friendship.admin_id, create: @friendship.create, destroy: @friendship.destroy, friend_id: @friendship.friend_id } }
